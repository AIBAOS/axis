...
- [x] **Phase 306 WebUI 系统设置界面** - 2026-03-28 18:50
  - SettingsView.vue: 系统设置主页 (标签页：基本/网络/通知)
  - 基本设置：主机名/时区/语言配置
  - 系统信息卡片 (版本/运行时间/设备型号/序列号)
  - 网络设置：DHCP/静态 IP 切换、IP/子网掩码/网关/DNS 配置
  - 当前网络状态显示 (MAC 地址/连接状态/IP/网速)
  - 通知开关 (系统/存储/备份/安全通知)
  - 邮件服务器配置 (SMTP/端口/用户名/密码/发件人/收件人)
  - SSL/TLS 加密选项、发送测试邮件
  - 表单验证 (主机名格式/IP 格式/邮箱格式)
  - 保存成功提示 (Toast)
  - 路由：/settings
  - 对接 API: GET/PUT /api/v1/settings/*, POST /api/v1/settings/email/test
  - Commit: e91bb8c
